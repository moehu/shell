...
wget -c https://raw.githubusercontent.com/moehu/kangle/master/php/7.1/718/php-7.1.8.tar.bz2 -O php-7.1.8.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://raw.githubusercontent.com/moehu/kangle/master/php/7.1/718/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://raw.githubusercontent.com/moehu/kangle/master/php/7.1/718/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://raw.githubusercontent.com/moehu/kangle/master/php/7.1/718/ioncube-$ZEND_ARCH-7.0.zip
...
#install apcu
wget -c https://raw.githubusercontent.com/moehu/kangle/master/php/7.1/718/apcu-5.1.3.tgz
...
wget -c https://raw.githubusercontent.com/moehu/kangle/master/php/7.1/718/libmemcached-1.0.18.tar.gz
...
make install
#install fileinfo
cd /php-7.1.8/ext/fileinfo
/vhs/kangle/ext/tpl_php718/bin/phpize
./configure -with-php-config=/vhs/kangle/ext/tpl_php718//bin/php-config --enable-fileinfo
make && make install
#install memcached
wget -c https://raw.githubusercontent.com/moehu/kangle/master/php/7.1/718/php-memcached-php7.zip
